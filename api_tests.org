...
get http://localhost:5000/calculate_neb_on_path?run=nano-pt&start=300&end=305

#+begin_src
curl http://localhost:5000/calculate_neb_on_path\?run\=nano-pt\&start\=300\&end\=305
#+end_src
